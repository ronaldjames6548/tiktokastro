            ...
            <g>
              <circle cx="84" cy="50" r="10" fill="#527eff">
                ...
                <animate
                  ...
                  values="#527eff;#2a12ff;#6ad6f8;#50d6d2;#527eff"
                  begin="0s"
                />
              </circle>
              ...
              <circle cx="50" cy="50" r="10" fill="#50d6d2">
                <animate
                  attributeName="r"
                  repeatCount="indefinite"
                  dur="1s"
              ...
              <circle cx="84" cy="50" r="10" fill="#6ad6f8">
                <animate
                  attributeName="r"
                  repeatCount="indefinite"
                  dur="1s"
              ...
              <circle cx="16" cy="50" r="10" fill="#2a12ff">
                <animate
                  attributeName="r"
                  repeatCount="indefinite"
                  dur="1s"
              ...
              <div class="flex justify-center flex-wrap">
                <div class="relative">
                  ...
                  <a
                    ...
                    href={`https://dl.tiktokiocdn.workers.dev/api/download?url=${encodeURIComponent(data()!.result.author?.avatar ?? "")}&type=.png&title=${data()!.result.author?.nickname ?? ""}`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="32"
          ...
          <div class="flex flex-col justify-center gap-2 mt-2 rounded-md shadow-md my-3 w-11/12 mx-auto">
            ...
            {data()!.result.videoHD && (
              <a
                ...
                class="p-2 bg-blue-600 shadow-md h-10 rounded text-white"
              >
                Download Video HD Without Watermaker
              </a>
            )}
            {data()!.result.videoWatermark && (
              <a
                href={`https://dl.tiktokiocdn.workers.dev/api/download?url=${encodeURIComponent(data()!.result.videoWatermark ?? "")}&type=.mp4&title=${data()!.result.author?.nickname}`}
                class="p-2 bg-blue-600 shadow-md h-10 rounded text-white"
              >
            ...
            {data()!.result.music && (
              <a
                href={`https://dl.tiktokiocdn.workers.dev/api/download?url=${encodeURIComponent(data()!.result.music ?? "")}&type=.mp3&title=${data()!.result.author?.nickname ?? ""}`}
                class="p-2 bg-blue-600 shadow-md h-10 rounded text-white"
              >
                Download Audio Only
              </a>
            ...
            {data()!.result.video_diyoun && (
              <a
                href={`https://dl.tiktokiocdn.workers.dev/api/download?url=${encodeURIComponent(data()!.result.video_diyoun ?? "")}&type=.mp4&title=${data()!.result.author?.nickname}`}
                class="p-2 bg-blue-600 shadow-md h-10 rounded text-white"
              >
                Download Diyoun Video HD Without Watermaker
              </a>
            )}
            <a
              class="p-2 bg-blue-600 shadow-md h-10 rounded text-white"
